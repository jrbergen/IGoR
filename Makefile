...
STRIP = strip
VERSION = 1.4.0
abs_builddir = /home/jrb/enpicom-local/code/IGoR
abs_srcdir = /home/jrb/enpicom-local/code/IGoR
...
install-demoDATA: $(demo_DATA)
	@$(NORMAL_INSTALL)
	@list='$(demo_DATA)'; test -n "$(demodir)" || list=; \
	if test -n "$$list"; then \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(demodir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(demodir)" || exit $$?; \
	done
...
uninstall-demoDATA:
	...
	dir='$(DESTDIR)$(demodir)'; $(am__uninstall_files_from_dir)
...
installdirs-am:
	for dir in "$(DESTDIR)$(bindir)" "$(DESTDIR)$(man1dir)" "$(DESTDIR)$(demodir)"; do \
...
install-data-am: install-data-local install-demoDATA install-man
...
uninstall-am: uninstall-binSCRIPTS uninstall-demoDATA uninstall-local \
	uninstall-man
...
.PHONY: $(am__recursive_targets) CTAGS GTAGS TAGS all all-am \
	...
	install-data-am install-data-local install-demoDATA \
	...
	uninstall-am uninstall-binSCRIPTS uninstall-demoDATA \
